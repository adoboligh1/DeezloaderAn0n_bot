...
from deezloader.deezloader.bin.deez-dw import link
...
def track(link, chat_id, quality):
    ...
    if match:
        ...
        try:
            ...
            sendMessage(
                chat_id, "Track doesn't %s exist on Deezer or maybe it isn't readable, it'll be downloaded from YouTube..." % link)
        ...
        if "track/" in link:
            ...
            if any(
                ...
                if count[0] > seconds_limits_album:
                    sendMessage(
                        chat_id, "If you do this again I will come to your home and I will ddos your ass :)")
                    delete(chat_id)
                    return
            ...
            # soundscrape(link)
            sendMessage(chat_id, "Im new and don#t talk to much!")
...
def menu(update, context):
    ...
    if text == "/start":
        ...
        sendMessage(
            chat_id, "Send the audio or voice message to identify the song")
        ...
        if chat_id in roots and "the cat is on the table" in text:
            ...
            if ans == "2" and users[chat_id]['c_downloads'] == 3:
                sendMessage(
                    chat_id, "Wait the end and repeat the step, did you think you could download how much songs you wanted? ;)")
            else:
                if ans == "2":
                    users[chat_id]['c_downloads'] += 1
